  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-2">
        ...
        <div className="text-xs p-2 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200 rounded border border-red-200 dark:border-red-700/50">Busuk (1-3)</div>
      </div>
      <p className="text-xs text-gray-500 dark:text-gray-400 mt-2 italic">
        Catatan: Nilai 4 tidak termasuk dalam standar SNI dan akan diabaikan dalam perhitungan.
      </p>
    </motion.div>
  );
});
