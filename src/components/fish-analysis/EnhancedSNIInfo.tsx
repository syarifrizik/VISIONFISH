...
const qualityLevels: QualityLevel[] = [
  {
    ...
    characteristics: [
      ...
      'Insang merah cerah tanpa lendir',
  ...
  },
  {
    ...
    characteristics: [
      'Mata agak keruh tapi masih cembung',
      'Insang merah muda dengan sedikit lendir',
  ...
  },
  {
    ...
    characteristics: [
      'Mata keruh dan mulai cekung',
      'Insang kemerahan dengan lendir',
      'Daging mulai lembek',
      'Bau mulai tidak segar'
    ],
  ...
  },
  {
    ...
    characteristics: [
      ...
      'Insang kecoklatan dengan lendir banyak',
      'Daging lembek dan mudah hancur',
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            {qualityLevels.map((level) => (
              <div
                key={level.score}
                className={`p-3 rounded-lg border text-center ${level.color}`}
              >
            ...
            <CollapsibleContent className="space-y-4 mt-4">
                      ...
                      <CardContent className="p-3">
                        <div className="flex items-center justify-between">
                          ...
                          <ChevronDown className={`w-4 h-4 transition-transform ${
                            selectedParameter === param.name ? 'rotate-180' : ''
                          }`} />
                        </div>
                        ...
                        <AnimatePresence>
                          {selectedParameter === param.name && (
                            ...
                            >
                              ...
                              <div>
                                <Badge className="bg-red-100 text-red-800 mb-1">Busuk (1-3)</Badge>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {qualityLevels.map((level) => (
                    <div key={level.score} className={`p-3 rounded-lg border ${level.color}`}>
