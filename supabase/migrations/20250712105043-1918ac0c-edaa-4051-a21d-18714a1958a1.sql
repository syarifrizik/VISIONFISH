...
-- First, let's add a system API key to the api_keys table
INSERT INTO api_keys (name, key_value, provider, daily_limit, is_active, created_by_admin)
VALUES ('System Gemini Key', 'AIzaSyDummy_Replace_With_Your_Actual_Key', 'gemini', 10000, true, '00000000-0000-0000-0000-000000000000')
